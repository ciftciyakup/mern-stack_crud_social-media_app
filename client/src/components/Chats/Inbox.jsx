...
import { clearErrors, getAllMessages, addNewMessage } from "../../slices/allMessagesSlice";
import { sendMessage, resetMessage } from "../../slices/newMessageSlice";
import { getUserDetailsById, resetUserDetails } from "../../slices/userDetailsSlice";
...
const Inbox = () => {
  ...
  return (
    <>
      <div className="mt-36 sm:mt-[4.7rem] pb-4 rounded h-[75vh] xl:w-2/3 mx-auto sm:pr-14 sm:pl-8">
        <div className="flex border h-full rounded w-full bg-white">
          <button
            className="sm:hidden absolute top-2 left-2 z-20 bg-white rounded-full p-2 shadow"
          ...
          {!userId ? (
            <div className="flex flex-col items-center justify-center w-full sm:w-4/6 gap-2">
              ...
              <h2 className="text-2xl font-thin">Mesajlarınız</h2>
              <p className="text-gray-400 text-sm">Bir arkadaşınıza özel mesajlar gönderin.</p>
              <button
                onClick={openModal}
            ...
            <div className="flex flex-col justify-between w-full sm:w-4/6">
              ...
              <div className="flex py-3 px-6 border-b items-center justify-between">
                <div className="flex gap-2 items-center">
                  ...
                  <span className="font-medium cursor-pointer">{friend.fullname}</span>
                </div>
                <svg
              ...
              >
                ...
                {message.trim().length > 0 ? (
                  <button className="text-primary-blue font-medium text-sm">Gönder</button>
                ) : (
                  <>
                    <svg
