...
import { getPostsOfFollowing } from "../../slices/postOfFollowingSlice";
...
const NewPost = ({ newPost, setNewPost }) => {
  ...
  return (
    <Dialog
      ...
      maxWidth="xl"
      PaperProps={{ className: "max-[720px]:flex-grow max-[720px]:mx-[29px]" }}
    >
      <div className="flex flex-col sm:w-[85vw] max-w-4xl">
        ...
        <div className="flex sm:flex-row sm:items-start items-center flex-col w-full">
          {postImage ? (
            ...
            >
              <svg
                aria-label="Görüntüler veya videolar gibi medyayı temsil eden simge"
                color="#262626"
                fill="#262626"
                height="77"
                role="img"
              ...
              <p className="text-xl text-center px-3">
                Fotoğrafları ve videoları buraya sürükleyin
              </p>
              <input
                type="file"
                accept="image/*"
          ...
          <div className="flex flex-col border-l sm:h-[80vh] w-full bg-white">
            ...
            <div className="p-3 w-full border-b relative">
              ...
              <textarea
                className="outline-none resize-none h-32 sm:h-auto max-[425px]:w-56"
